...
const Page = () => {
  return (
    <DefaultLayout>
      <div className="drawer drawer-open flex h-lvh font-semibold text-bodydark2 dark:bg-boxdark">
        <div role="tablist" className="tabs tabs-lifted m-auto mt-3">
          <input
            type="radio"
            name="my_tabs_2"
            role="tab"
