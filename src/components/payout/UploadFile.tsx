...
const UploadFile = () => {
  return (
    <>
      <div className="mx-auto h-lvh w-1/2 w-full">
        <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          <div className="border-b border-stroke px-7 py-4 dark:border-strokedark">
            <h3 className="font-medium text-black dark:text-white">Upload</h3>
          </div>
          <div className="p-7">
            <form action="#">
              <div
              ...
              >
                ...
                <div className="flex flex-col items-center justify-center space-y-3">
                  ...
                  <p className="mt-1.5">CSV, XLS, XLSX </p>
                  <p>(max, 800 X 800px)</p>
                </div>
              </div>
              ...
              <div className="relative mb-3">
                ...
                <div
                  className="absolute inset-0 left-auto right-5 flex items-center hover:cursor-pointer"
                  onClick={() => console.log("dkdjfn")}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className=" h-5 w-5 "
